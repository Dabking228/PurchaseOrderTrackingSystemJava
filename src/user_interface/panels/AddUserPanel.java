...
public class AddUserPanel extends Panel<Account> {
    ...
    private JButton editConfirm, editCancel, deleteButton, editButton;
    ...
    public AddUserPanel(Backend backend, MainMenu parent, boolean viewOnly) {
                ...
                editConfirm.addActionListener(e -> {
                    ...
                    try {
                        ...
                        if (!username.equals(account.getUsername())) {
                            ...
                            backend.db.accountsMap.get(accountList.getObjectUUID(account.getUsername())).setUsername(username);
                        }
                        if (!password.equals(account.getPassword())) {
                            System.out.println("pass changed"); // TODO: remove
                            backend.db.accountsMap.get(accountList.getObjectUUID(account.getUsername())).setPassword(password);
                        }
                        if (!role.equals(getRoleString(account.getRole()))) {
                            System.out.println("role changed"); // TODO: remove
                            backend.db.accountsMap.get(accountList.getObjectUUID(account.getUsername())).setRole(getRoleFromString(roleString));
                        }
    ...
    public void setData() {
        if (viewOnly) {
            account = accountList.getObject(rowData);
            System.out.println("yay"); // TODO: Remove
            System.out.println(rowData); // TODO: Remove
            System.out.println(accountList.getObject(rowData).getPassword()); // TODO: Remove
